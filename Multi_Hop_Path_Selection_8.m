...
% % Preguntar al usuario si quiere usar archivo predefinido
% respuesta = input("¿Usar constelación predefinida? (y/n): ", "s");
% usePredefined = lower(respuesta) == "y";
% 
% if usePredefined
%     tleFile = "leoSatelliteConstellation.tle";  % archivo fijo
% else
%    [tleFile,usePredefined] = loadConstellationTLE2();  % desde web, a escoger
%end
%%
% Paso 1: interfaz
...
for i = 1:num
    ...
    cleanedFile = cleanTLE(archivo, 30, 5e-4, 5e-3); % % Limpiar por fecha (ejemplo 15 días bien, con 2 dias mas preciso) {5e-4, 5e-3} UMBRALES PARA CONSTELACIÓN LEO
